              ...
              <div className="flex items-start justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-white/60">
                    Set risk, stop-loss, and goals before spinning. Stick to the
                    script live.
                  </p>
                </div>
                <div className="px-3 py-2 bg-white/5 rounded-lg border border-white/10 text-xs uppercase tracking-widest">
                  Stream Safe
                </div>
              </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {quickAdjustments.map((value) => (
                      <QuickAdjustButtons
                        key={value}
                        value={value}
                        onWin={() => addEntry('win', value, `Quick +${value}`)}
                        onLoss={() =>
