      ...
      <div className="border border-white/8 bg-zinc-broadcast/40 p-3 space-y-2">
        {!opening ? (
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 border border-purple-gamba/40 text-purple-bright hover:bg-purple-gamba/15 transition-colors duration-150"
          >
    ...
    <div className="border border-purple-gamba/30 bg-purple-gamba/5 p-3 space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={copy}
          title={url}
          className="shrink-0 inline-flex items-center gap-1 px-2.5 py-2 border border-emerald-signal/40 text-emerald-signal hover:bg-emerald-signal/10 transition-colors"
        >
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-eyebrow-lg text-white/65 font-mono">
          <span className="text-purple-bright tabular-nums">06</span>
      ...
      {/* Owner: password-gated public submission link */}
      {isLoggedIn && (
        <LinkControls
          linkId={linkId}
          linkOpen={linkOpen}
